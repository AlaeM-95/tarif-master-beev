...
export type PdfDisplayConfig = {
  ...
  showCurrentFleetVehicle: boolean; // afficher la fiche détaillée des véhicules « flotte actuelle » dans la présentation
...
export const DEFAULT_PDF_CONFIG: PdfDisplayConfig = {
  ...
  showCurrentFleetVehicle: false, // par défaut, pas de fiche détaillée pour les véhicules à remplacer (visibles dans le comparateur)
...
export const CONFIG_GROUPS: ConfigGroup[] = [
  {
    ...
    items: [
      ...
      { key: "showCurrentFleetVehicle", label: "Fiche détaillée flotte actuelle", description: "Afficher la fiche véhicule complète des véhicules marqués « flotte actuelle » (par défaut ils n'apparaissent que dans le comparateur)", appliesTo: ["vehicles"] as unknown as string[] } as any,
